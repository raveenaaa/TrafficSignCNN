...
# Change these
data_filename = "./data/data1.pickle"
pkl_filename = "data1_model.pkl"

plot_acc = "./training_plots/data1_acc.png"
plot_loss = "./training_plots/data1_loss.png"

file_training_validation_results = "./data1_train_validate_results.txt"
file_testing_results = "./data1_test_results.txt"
# Change these: ends
