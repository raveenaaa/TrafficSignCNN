...
# Change these
data_filename = "./data/data2.pickle"
pkl_filename = "./saved_models/data2_model.pkl"

plot_acc = "./training_plots/data2_acc.png"
plot_loss = "./training_plots/data2_loss.png"

file_training_validation_results = "./results/train_validate/data2_train_validate_results.txt"
file_testing_results = "./results/test/data2_test_results.txt"
best_model_results = "./results/best_models/data2_best_model.txt"
# Change these: ends
