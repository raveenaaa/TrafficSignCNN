...
# Change these
choice = 5        # data file (5, 6, 7) are left

data_filename = "./data/data{}.pickle".format(choice)
pkl_filename = "./saved_models/data{}_model.pkl".format(choice)

plot_acc = "./training_plots/data{}_acc.png".format(choice)
plot_loss = "./training_plots/data{}_loss.png".format(choice)

file_training_validation_results = "./results/train_validate/data{}_train_validate_results.txt".format(choice)
file_testing_results = "./results/test/data{}_test_results.txt".format(choice)
best_model_results = "./results/best_models/data{}_best_model.txt".format(choice)
# Change these: ends
